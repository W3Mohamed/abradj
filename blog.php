...
<body>
    ...
    <div class="page-blog">
        ...
        <div class="blog">
            ...
            <p>
                <?php
                $extrait = substr($blog['contenu'], 0, 100); // Coupe après 100 caractères
                echo htmlspecialchars($extrait) . '...'; // Ajoute "..." pour indiquer la coupure
                ?>
            </p>
            <a href="actualite.php?id_blog=<?=$blog['id_blog']?>">Voir plus</a>
        </div>
        <?php } ?>
    </div>
    <!--====================================================
